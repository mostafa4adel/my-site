            ...
            <div className="col-md-6 mt-3 mt-md-0">
                    <div className="card">
                        <div className="card-body">
                            ...
                            <h6 className="card-subtitle mb-2 text-muted">C, C++, Java, Python, JavaScript, PHP</h6>
                ...
                <div className="col-md-6 mt-3 mt-md-0">
                    <div className="card">
                        <div className="card-body">
                            ...
                            <h6 className="card-subtitle mb-2 text-muted">Embaded C, AutoSar, ARM development, ROS</h6>
